...
class Event(EventBase,m5.internal.serialize.Serializable):
    ...
    def isAutoDelete(self): return _event.Event_isAutoDelete(self)
...
class EventQueue(m5.internal.serialize.Serializable):
    ...
    def getHead(self): return _event.EventQueue_getHead(self)
    ...
    def wakeup(self, *args): return _event.EventQueue_wakeup(self, *args)
    ...
    def checkpointReschedule(self, *args): return _event.EventQueue_checkpointReschedule(self, *args)
