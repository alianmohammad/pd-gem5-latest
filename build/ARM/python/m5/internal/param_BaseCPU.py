...
class BaseCPUParams(m5.internal.param_MemObject.MemObjectParams):
    ...
    dstage2_mmu = _swig_property(_param_BaseCPU.BaseCPUParams_dstage2_mmu_get, _param_BaseCPU.BaseCPUParams_dstage2_mmu_set)
    ...
    istage2_mmu = _swig_property(_param_BaseCPU.BaseCPUParams_istage2_mmu_get, _param_BaseCPU.BaseCPUParams_istage2_mmu_set)
