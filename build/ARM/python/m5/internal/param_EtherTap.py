...
class EtherTap(m5.internal.param_EtherObject.EtherObject):
...
class EtherTapParams(m5.internal.param_EtherObject.EtherObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    num_nodes = _swig_property(_param_EtherTap.EtherTapParams_num_nodes_get, _param_EtherTap.EtherTapParams_num_nodes_set)
    port = _swig_property(_param_EtherTap.EtherTapParams_port_get, _param_EtherTap.EtherTapParams_port_set)
    server = _swig_property(_param_EtherTap.EtherTapParams_server_get, _param_EtherTap.EtherTapParams_server_set)
    server_ip = _swig_property(_param_EtherTap.EtherTapParams_server_ip_get, _param_EtherTap.EtherTapParams_server_ip_set)
    sync_quantum = _swig_property(_param_EtherTap.EtherTapParams_sync_quantum_get, _param_EtherTap.EtherTapParams_sync_quantum_set)
    port_tap_connection_count = _swig_property(_param_EtherTap.EtherTapParams_port_tap_connection_count_get, _param_EtherTap.EtherTapParams_port_tap_connection_count_set)
    def __init__(self): 
